...
<head>
    ...
    <title>Sistem Informasi Poliklinik - Data Dokter</title>
        ...
        <tbody>
            ...
            while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <td><?= $row['no_hp'] ?></td>
                    <td>
                        <a href="dokter.php?edit=<?= $row['id'] ?>" class="btn btn-success btn-sm">Ubah</a>
                        <a href="dokter.php?delete=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
                    </td>
                </tr>
            <?php endwhile; ?>
        </tbody>
